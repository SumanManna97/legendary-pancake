...
body{
	...
	background: linear-gradient(90deg, rgba(131,58,180,1) 0%, rgba(26,237,164,1) 50%, rgba(252,176,69,1) 100%);
	color:black;
	font-size:20px;
	font-weight:bolder;
	margin:2rem;
